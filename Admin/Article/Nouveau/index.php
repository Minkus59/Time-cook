...
<option value="<?php echo $Home."/Menu/"; ?>" <?php if ((isset($_GET['id']))&&($Actu->page == $Home."/Menu/")) { echo "selected"; } ?>>Menu</option>
<option value="<?php echo $Home."/Mentions-legales/"; ?>" <?php if ((isset($_GET['id']))&&($Actu->page == $Home."/Mentions-legales/")) { echo "selected"; } ?>>Mentions-légales</option>
