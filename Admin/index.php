        ...
        elseif ($Mdp2!=$Mdp) {
           $Erreur="Les mots de passe ne sont pas identique !"; 
            ...
            if($NbCompte==0) {
                ...
                $Insert=$cnx->prepare("INSERT INTO ".$Prefix."neuro_Logo (logo) VALUES(:logo)");
                $Insert->BindParam(":logo", $Default, PDO::PARAM_STR);
                $Insert->execute();
                ...
                $Insert->BindParam(":lien", $Home."/", PDO::PARAM_STR);
...
if (($Cnx_Admin!=TRUE)||($Cnx_User!=TRUE)) { ?>
