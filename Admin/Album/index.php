    ...
    if ($_FILES['photo']['name']!="") {
        ...
        if (in_array($ext_origin, $ext2)) {
            if($taille_origin>$taille_max) {
                $Erreur = "fichier trop volumineux, il ne doit dÈpassÈ les 20Mo";
            }
            ...
            if (!isset($Erreur)) {
                ...
                if ($UpMaqimg==false) {
                        $Erreur="Erreur de tÈlÈchargement, veuillez rÈassayer ultËrueurement";
                }
                else {
                    $_SESSION['Etape']="2";
...
if (isset($_POST['Valider'])) {
        ...
        if (!$Insert) {
            ...
            $Valid="Article ajouter avec succËs";
